...
class TestClientHTTPMethods:
    ...
    def test_post_method(self):
        ...
        with patch.object(self.client._client, 'post', return_value=mock_response) as mock_post:
    ...
    def test_delete_method(self):
        ...
        with patch.object(self.client._client, 'delete', return_value=mock_response) as mock_delete:
